export default function getTerminalAndDebugging(scheme, term) {
  return {
    ...
    "terminal.border": `${scheme.background}00`,
    ...
    "terminal.findMatchBorder": `${scheme.background}00`,
    "terminal.findMatchHighlightBackground": `${scheme.tertiaryContainer}33`,
    "terminal.findMatchHighlightBorder": `${scheme.background}00`,
    ...
    "terminal.tab.activeBorder": `${scheme.background}00`,
    ...
    "debugToolBar.border": `${scheme.background}00`,
    ...
    "diffEditor.insertedTextBorder": `${scheme.background}00`,
    "diffEditor.removedTextBackground": `${scheme.errorContainer}33`,
    "diffEditor.removedTextBorder": `${scheme.background}00`,
    "diffEditor.border": `${scheme.background}00`,
    ...
    "diffEditor.move.border": `${scheme.background}00`,
    "diffEditor.moveActive.border": `${scheme.background}00`,
    "multiDiffEditor.headerBackground": scheme.surfaceContainerHigh,
    "multiDiffEditor.background": scheme.surfaceContainer,
    "multiDiffEditor.border": `${scheme.background}00`,
  };
}