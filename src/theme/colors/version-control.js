export default function getVersionControl(scheme, term) {
  return {
    ...
    "merge.border": `${scheme.background}00`,
    ...
    "mergeEditor.conflict.unhandledUnfocused.border": `${scheme.background}00`,
    "mergeEditor.conflict.unhandledFocused.border": `${scheme.background}00`,
    "mergeEditor.conflict.handledUnfocused.border": `${scheme.background}00`,
    "mergeEditor.conflict.handledFocused.border": `${scheme.background}00`,
    ...
    "peekView.border": `${scheme.background}00`,
    ...
    "peekViewEditor.matchHighlightBorder": `${scheme.background}00`,
